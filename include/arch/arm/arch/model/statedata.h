...
#if defined(CONFIG_BENCHMARK_TRACK_UTILISATION) || defined(CONFIG_BENCHMARK_TRACK_KERNEL_ENTRIES)
NODE_STATE_DECLARE(uint64_t, ksEnter);
#endif /* defined(CONFIG_BENCHMARK_TRACK_UTILISATION) || defined(CONFIG_BENCHMARK_TRACK_KERNEL_ENTRIES) */
