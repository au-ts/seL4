...
enum benchmark_track_util_ipc_index {
    ...
    /* Number of instructions thread spends in kernel */
    BENCHMARK_TCB_KERNEL_INSTRUCTION,
    /* Number of instructions idle thread spends in kernel */
    BENCHMARK_IDLE_KERNEL_INSTRUCTION,
};
